...
<div class="d-flex justify-content-between align-items-center mb-4">
    ...
    {{-- Tombol Tambah Buku dihapus untuk user --}}
                ...
                <tbody>
                    @forelse($books as $book)
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('books.show', $book) }}" class="text-primary text-decoration-none">
                                    {{ $book->judul }}
                                </a>
                            </td>
                            <td>{{ $book->penulis }}</td>
